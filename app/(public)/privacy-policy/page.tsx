...
export default async function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto p-8">
      <PageHero title="Privacy Policy" subtitle="Effective Date: 10/11/2024" />
      ...
      <main className="max-w-4xl mx-auto py-10 px-6">
        <section className="mb-8">
          ...
          <p className="mt-2 text-slate-700">
            ...
            your information when you use our TikTok analytics platform, which
            integrates directly with TikTok (“Platform”). By accessing or using
            the Platform, you agree to the collection and use of your data in
            accordance with this Privacy Policy. If you do not agree with our
            practices, please discontinue the use of our services.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside mt-2 text-slate-700">
            <li>
              ...
              such as your username, profile details, follower count, and other
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside mt-2 text-slate-700">
            ...
            <li>
              ...
              or processing data on our behalf, under strict confidentiality
              agreements.
            </li>
            <li>
